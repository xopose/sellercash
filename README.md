...
- анализа внешних неструктурированных сигналов.
...
SellerCash объединяет в едином контуре три класса методов: cashflow-моделирование, сценарный анализ и извлечение экономических событий из текста. Объект прогнозирования денежный остаток с лагами выплат, возвратами и удержаниями.
